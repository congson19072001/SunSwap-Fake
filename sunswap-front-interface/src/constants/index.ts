import { ChainId, JSBI, Percent, Token, WETH } from 'sunswap-sdk'
...
export const SHIB = new Token(
  ...
  '0xd55D28217fc399D588467B92DFF9D4AAD65B0fE8',
  18,
  'SHIB',
  'SHIBA INU'
)
export const DAI = new Token(
  ChainId.POLYGON_MUMBAI,
  '0x7a5BBb6463D7eD92d061C4F193998a025317c025',
  18,
  'DAI',
  'Dai Stablecoin'
)
export const USDC = new Token(ChainId.POLYGON_MUMBAI, '0x73a9078a90C7317698c3eb5071E71BF4e428fAE3', 6, 'USDC', 'USD//C')
...
export const LINK = new Token(
  ChainId.POLYGON_MUMBAI,
  '0x588B1C7be2658a6AD7f84a8C05ec8acA0283B1d1',
  18,
  'LINK',
  'ChainLink Token'
)
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...WETH_ONLY,
  [ChainId.MAINNET]: [...WETH_ONLY[ChainId.MAINNET], BNB, USDC, SHIB]
}
